    ...
    <mat-tab-group>
      <mat-tab label="All Ideas">
        <section class="flex flex-col items-center gap-2 sm:gap-4 pt-4">
          ...
          <div class="w-full rounded-xl border bg-white divide-y divide-dashed">
            <conidea-idea-card
              [idea]="idea"
      ...
      <mat-tab label="My Ideas">
        <section class="flex flex-col items-center gap-2 sm:gap-4 pt-4">
          @if (ideaFilter(ideas).length > 0) { @for (idea of ideaFilter(ideas);
          track idea._id) {
          <div class="w-full rounded-xl border bg-white divide-y divide-dashed">
            <conidea-idea-card
              [idea]="idea"
          ...
          } } @else { Once posted your ideas appear here. }
        </section>
      </mat-tab>
    </mat-tab-group>
  `,
